...
require '../gd.php';
$result = CreateHelper::CreatePalette([
    'x_size' => 100,
    'y_size' => 100,
    'red' => 255,
    'green' => 255,
...
CreateHelper::ImagesMerge($mainBg, $codeBg, 31, 695, 0, 0, 91, 91, 100);
CreateHelper::ImagesMerge($mainBg, $goodBg, 21, 86, 0, 0, 409, 389, 100);
